...
def calculate_bounds(img, epsilon):
    img = cv2.resize(img, (456, 256), interpolation=cv2.INTER_CUBIC)
    img = img[128 - 112:128 + 112, 228 - 112:228 + 112, :]
...
def preprocess_image(cv2im, resize_im=True):
    ...
    # Resize image
    if resize_im:
        cv2im = cv2.resize(cv2im, (456, 256), interpolation=cv2.INTER_CUBIC)
        cv2im = cv2im[128-112:128+112, 228-112:228+112, :]
